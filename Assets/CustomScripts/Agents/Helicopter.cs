...
public class Helicopter : MonoBehaviour
{
    ...
    private void Start()
    {
        this.gunAudioSource = this.gameObject.AddComponent<AudioSource>();
        this.gunAudioSource.playOnAwake = false;
        this.gunAudioSource.loop = false;
        this.gunAudioSource.spatialize = true;
        this.gunAudioSource.spatialBlend = 1.0f;
        this.gunAudioSource.dopplerLevel = 0.0f;
        this.gunAudioSource.rolloffMode = AudioRolloffMode.Logarithmic;
        this.gunAudioSource.maxDistance = 20f;
        var blulletSound = Resources.Load<AudioClip>("Bullet");
        this.gunAudioSource.clip = blulletSound;
    }
